...
const sasURL =
  "https://ovitrampa.blob.core.windows.net/imagenes-ovitrampa/gestion.json?sp=rw&st=2025-06-22T19:54:58Z&se=2025-07-26T03:54:58Z&sv=2024-11-04&sr=b&sig=4hbWLUnd8eE9IRFV2GqblzUm69K6hN8Mr0ViQu6xQM0%3D";
...
const fetchAndOverwrite = async () => {
  try {
    ...
    console.log(
      "Archivo gestion.json actualizado exitosamente en Azure Blob Storage"
    );
  } catch (error) {
